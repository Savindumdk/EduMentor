...
----------------------
Traditional Experta rule-based expert system for O/L Chemistry topics.
...
class ChemistryExpert(KnowledgeEngine):
    """
    Expert system for Chemistry questions using traditional @Rule format.
    ...
    - And many more O/L Chemistry topics from the complete textbook knowledge base
    """
    ...
    def rule_mixtures(self):
        ...
        self.response = {
            'concept': 'Mixtures',
            'explanation': """A mixture is a combination of two or more substances that are not chemically bonded.
...
**Types of mixtures:**
1. **Homogeneous mixtures** (solutions) - Uniform composition throughout
...
**Common examples:**
• Air (gases mixed together)
• Sea water (water + dissolved salts)
• Soil (minerals, organic matter, water, air)""",
            'topic': 'Chemistry',
            'subtopic': 'Matter and Mixtures',
            'examples': [
                "Salt dissolved in water forms a homogeneous mixture",
                "Sand and iron filings form a heterogeneous mixture",
                "Air is a mixture of nitrogen, oxygen, and other gases"
            ]
        }
        self.halt()
    
    @Rule(Fact(query_topic='separation techniques'))
    def rule_separation(self):
        """Methods to separate components of mixtures."""
        self.response = {
            'concept': 'Separation Techniques',
            'explanation': """Various methods are used to separate components of mixtures based on their physical properties.

**Common separation techniques:**

1. **Filtration** - Separates solid from liquid using a filter
   • Used when: Solid particles in liquid
   • Example: Separating sand from water

2. **Evaporation** - Liquid is heated to leave solid behind
   • Used when: Dissolved solid in liquid
   • Example: Getting salt from sea water

3. **Distillation** - Separates liquids with different boiling points
   • Used when: Mixture of liquids
   • Example: Separating water and alcohol

4. **Chromatography** - Separates based on different rates of movement
   • Used when: Mixture of dissolved substances
   • Example: Separating ink colors

5. **Magnetic separation** - Uses magnets to remove magnetic materials
   • Example: Removing iron from a mixture""",
            'topic': 'Chemistry',
            'subtopic': 'Separation Techniques',
            'examples': [
                "Filter coffee to separate grounds from liquid",
                "Distill crude oil to get petrol, diesel, etc.",
                "Use chromatography to identify food colorings"
            ]
        }
        self.halt()
    ...
    @Rule(NOT(Fact(query_topic=W())))
    def no_match(self):
        """No chemistry topic matched."""
        self.response = {
            'concept': 'No Match',
            'explanation': """I couldn't find a Chemistry topic matching your question.
...
Please rephrase your question about one of these topics.""",
            'topic': 'Chemistry',
            'subtopic': 'Unknown',
            'examples': []
        }
    ...
    def get_response(self):
        """Get the expert system's response."""
        return self.response
